...
5     continue
      ...
      real*8 function boundint(r,u,hx,hy,t,pi)
      implicit real*8 (a-h,o-z)
      DIMENSION R(3)
      boundint=1.5d0*u/(hx/2.d0)**2/(hy/2.d0)**2*
     &(hx/2.d0*r(1)**2-r(1)**3/3.d0)*(hy/2.d0*r(3)**2-r(3)**3/3.d0)
      if (t.le.2.d0-1.d-10) 
     & boundint=boundint*(1.d0-dcos(pi/2.d0*t))/2.d0
      RETURN
      END
