      subroutine Mmfsic(filename,kkcom)
...
1001  format(1x,7i7)
      ...
      write(*,*) 'memory needed = ',kna10,' in prgram mfsic'
      stop 55555
      endif
      call mfsic(neqm,ia(kna0),ia(kna1),ia(kna2),
     ...
     *filename)
      ...
      subroutine mfsic(neqm,nbindex,val,nupdate,
